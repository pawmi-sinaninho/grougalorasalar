...
def test_rules_profile_encodes_verified_target_geometry() -> None:
    ...
    assert repulsion["cardinalFinalDistanceFromPillar"] == 3
    assert repulsion["diagonalFinalDistanceFromPillar"] == 2
...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("movement.repulsion.diagonalFinalDistanceFromPillar", 3),
